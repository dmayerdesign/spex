...
# argument-hint: [optional: specific build step number or component to implement]
---

Use the `spex-implement` skill.
...
Implement that specific build step or component. Otherwise, identify the next unfinished step in the design's build sequence.
